...
//  NOT: Senin ADB çıktındaki "led:switch_0" adresinin tam yolu buraya eklendi.
#define TOGGLE_SWITCH "/sys/devices/platform/soc/c440000.qcom,spmi/spmi-0/spmi0-05/c440000.qcom,spmi:qcom,pm6150l@5:qcom,leds@d300/leds/led:switch_0/brightness"

static std::string kTorchLedPaths[] = {
    //  NOT: Senin ADB çıktındaki "led:torch_0" (Sarı LED grubu) tam yolu:
    ...
    //  NOT: Senin ADB çıktındaki "led:torch_1" (Beyaz LED grubu) tam yolu:
